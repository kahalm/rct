...
public class CalcPositionListItemDto
{
    ...
    /// <summary>Selbstbewertung als Stufe (<see cref="Rct.Api.Models.CalculationGrade"/>, 0–4);
...
public interface ICalcMetaInput
{
    ...
    /// <summary>Selbstbewertung als Stufe 0–4 (<see cref="Rct.Api.Models.CalculationGrade"/>).
