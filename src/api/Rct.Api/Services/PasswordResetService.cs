...
public class PasswordResetService
{
    ...
    private static (string subject, string html, string text) BuildEmail(string username, string link)
    {
        ...
        var text =
            $"Hallo {username},\n\n" +
            "für dein Real-Chess-Training-Konto wurde ein Zurücksetzen des Passworts angefordert.\n" +
    ...
    /// <summary>SHA-256-Hex (lowercase) eines Roh-Tokens.</summary>
