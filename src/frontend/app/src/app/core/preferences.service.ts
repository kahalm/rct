...
export class PreferencesService {
  ...
  /** RCT: kein Profil-Endpoint — Einstellungen bleiben Geräte-lokal (localStorage).
   *  Bleibt als No-op erhalten, weil auth.service sie nach dem Login aufruft; reaktivierbar,
   *  sobald RCT ein /api/profile bekommt (RookHub-Original siehe dort). */
  loadFromServer(): void {
    // bewusst leer
  }
  ...
  /** RCT: kein Profil-Endpoint — bewusster No-op (Einstellungen nur lokal). */
  private saveToServer(_partial: Partial<ProfilePreferences>): void {
    return;
  }
